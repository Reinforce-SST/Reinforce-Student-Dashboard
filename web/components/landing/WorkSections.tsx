    ...
    <section className={`${styles.band} ${styles.alt}`} id="ledger" aria-labelledby="ledger-heading">
      <div className={styles.page}>
        <div className={styles.center}>
          ...
          <p className={`${styles.lede} ${styles.rise}`} data-animate="rise" style={stagger(2)}>
            File it in Discord. See it on the web. Project groups, resource requests and ideas share one record across the bot and the dashboard.
          </p>
        </div>
        <ol className={`${styles.three} ${styles.threeSpaced}`}>
          {[
            ...
            ["It shows up", "Your linked Discord tickets appear on the dashboard, with their status and a link back to the conversation."],
        ...
        <div className={`${styles.split} ${styles.botSplit}`}>
          <div className={styles.rise} data-animate="rise">
            ...
            <ul className={styles.ticks}>
              ...
              <li>Your Discord tickets, together on the dashboard</li>
            </ul>
          </div>
          <div className={`${styles.code} ${styles.rise}`} data-animate="code" style={stagger(1)}>
            ...
            <pre><code>
              <span className={styles.ln} style={rowDelay(0)}><span className={styles.c1}>/verify</span></span>
